...
function td_blog(item) {
  ...
  if (item.id == loading) {
    ...
    <div class="info">A conversation with Fereshteh Forough, founder and president of Afghanistan Code to Inspire</div>
    ...
    <div class="blog_content">
      ...
      <div class="video_section">
        ...
        <video class="videle" src="https://www.youtube.com/watch?v=nJZcbidTutE" controls class="video">
